...
async def run_agent(message: str):
    ...
    if not google_maps_key:
        ...
        raise ValueError("🚨 Missing Gemini API Key. Please enter it in the sidebar.")
    ...
    async with MultiMCPTools(
        ...
        maps_agent = Agent(
            tools=[mcp_tools],
            model=GeminiChat(id="gemini-pro-2.0", api_key=gemini_key), 
            name="Maps Agent",
